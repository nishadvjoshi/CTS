<%-- 
    Document   : ctsUser
    Created on : 11 Sep, 2017, 7:15:32 PM
    Author     : Admin
--%>
...
function deleteRecord(id,User){
  ...
  if(doIt){
   var f=document.form;
    ...
    window.location.href="UserController?action=delete&userID="+id;
    f.submit();
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" method="POST" class="sign" id="commentForm" action='UserController' name="frmAddUser">
                    <p><button type="submit" name="AddUser" value="AddUser" class="btn btn-primary">New User</button></p>
                </form>   
                                        ...
                                        <tbody>
                                            <c:forEach items="${users}" var="user">
                                                <tr>
                                                 ...
                                                 <td><a href="#" onclick="deleteRecord(<c:out value="${user.cmu_ID},'${user.cmu_UserName}'" /> );">Delete</a></td>
                                                ...
                                                <!--    <td><c:out value="${user.cmu_Password}" /></td>-->
                                                    ...
                                                    <td><c:out value="${user.cmu_Role}" /></td>                                                
                                                  <!--  <td><fmt:formatDate value="${user.cmu_CreateDate}" pattern="dd/MM/yyyy" /></td> 
                                                    <td><c:out value="${user.cmu_CreateUser}" /></td>
                                                    <td><fmt:formatDate value="${user.cmu_ModifyDate}" pattern="dd/MM/yyyy" /></td>                                                 
