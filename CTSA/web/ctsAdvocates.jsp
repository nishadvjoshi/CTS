<%-- 
    Document   : ctsAdvocates
    Created on : 3 Oct, 2017, 2:19:08 PM
    Author     : Admin
--%>
...
function deleteRecord(id,Advocate){
  ...
  if(doIt){
   var f=document.form;
    ...
    window.location.href="AdvocateController?action=delete&AdvocateID="+id;
    f.submit();
    
    }
  else{
window.location.href="AdvocateController?action=listAdvocate";
    }
}
</script>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" action="ctsAddAdvocate.jsp">
                    <p><button type="submit" name="AddAdvocate" value="AddAdvocate" class="btn btn-primary">New Advocate</button></p>
                </form>   
                            ...
                            <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                                    ...
                                    <tr >
                                         ...
                                         <!--   <th>AdvocateID</th>                    -->
                                          ...
                                          <!--  <th>Alternate Cell Number</th>
                                            ...
                                            <th>Permanent Nearby Location</th>
                                ...
                                <tbody>
                                    <c:forEach items="${advocates}" var="advocate">
                                            <tr>
                                                <td><a href="AdvocateController?action=edit&AdvocateID=<c:out value="${advocate.cam_ID}"/>">Edit</a></td>
                                             <!--   <td><a href="AdvocateController?action=delete&AdvocateID=<c:out value="${advocate.cam_ID}"/>">Delete</a></td>-->
                                                 <td><a href="#" onclick="deleteRecord(<c:out value="${advocate.cam_ID},'${advocate.cam_FirstName}'" /> );">Delete</a></td>
                                                
                                               <!-- <td><c:out value="${advocate.cam_ID}" /></td>-->
                                                <td><c:out value="${advocate.cam_FirstName}" /></td>                                                
                                               <!-- <td><c:out value="${advocate.cam_AdvocateType}" /></td>-->
                                              <!--  <td><c:out value="${advocate.cam_AdvocateCode}" /></td>-->
                                              <!--  <td><c:out value="${advocate.cam_LicenseNo}" /></td>-->
                                                <td><c:out value="${advocate.cam_EmailID1}" /></td>
                                               <!-- <td><c:out value="${advocate.cam_EmailID2}" /></td>-->
                                                <td><c:out value="${advocate.cam_CellNo1}" /></td>
                                               <!-- <td><c:out value="${advocate.cam_CellNo2}" /></td>
                                                <td><c:out value="${advocate.cam_LandlineNo}" /></td>
                                                <td><c:out value="${advocate.cam_Addr1}" /></td>
                                                <td><c:out value="${advocate.cam_Addr2}" /></td>
                                                <td><c:out value="${advocate.cam_NearLocation}" /></td>
                                                <td><c:out value="${advocate.cam_District}" /></td>
                                                <td><c:out value="${advocate.cam_City}" /></td>
                                                <td><c:out value="${advocate.cam_State}" /></td>
                                                <td><c:out value="${advocate.cam_Country}" /></td>
                                                <td><c:out value="${advocate.cam_ZipCode}" /></td>
                                                <td><c:out value="${advocate.cam_PAddr1}" /></td>
                                                <td><c:out value="${advocate.cam_PAddr2}" /></td>
                                                <td><c:out value="${advocate.cam_PNearLocation}" /></td>
                                                <td><c:out value="${advocate.cam_PDistrict}" /></td>
                                                <td><c:out value="${advocate.cam_PCity}" /></td>
                                                <td><c:out value="${advocate.cam_PState}" /></td>
                                                <td><c:out value="${advocate.cam_PCountry}" /></td>
                                                <td><c:out value="${advocate.cam_PZipCode}" /></td>
                                                <td><c:out value="${advocate.cam_PassportNo}" /></td>
                                                <td><fmt:formatDate value="${advocate.cam_DOB}" pattern="dd/MM/yyyy" /></td>                                               
                                                <td><fmt:formatDate value="${advocate.cam_CreateDate}" pattern="dd/MM/yyyy" /></td>
                                                <td><c:out value="${advocate.cam_CreateUser}" /></td>
                                                <td><fmt:formatDate value="${advocate.cam_ModifyDate}" pattern="dd/MM/yyyy" /></td>
                                                <td><c:out value="${advocate.cam_ModifyUser}" /></td>
                                                <td><c:out value="${advocate.cam_DeleteFlag}" /></td>
                                                <td><c:out value="${advocate.cam_ActiveFlag}" /></td>-->
