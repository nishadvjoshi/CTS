<%-- 
    Document   : ctsCaseMaster
    Created on : 16 Jun, 2018, 1:03:46 PM
    Author     : Admin
--%>
...
<script>
    function deleterecord(id,caseno,filename)
    {
        var doIt=confirm('Do you want to delete cases where \n Case ID : '+id+ '\n Case No is  : '+caseno+' \n File Name  : '+filename);
        
        
        if(doIt)
        {
            window.location.href='CaseMasterController?action=delete&CaseMasterID='+id;
        }
        else
        {}
    }
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" method="POST" action='CaseMasterController' name="frmAddCaseDetail">
                    <p><button type="submit" name="AddCase" value="AddCase" class="btn btn-primary">New Case</button></p>
                </form>   
                            ...
                            <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0" >
                                    ...
                                    <tr>
                                      ...
                                      <!--  <th>CaseMasterID</th>   -->
                                       ...
                                       <!-- <th>Register No</th>  -->                                                            
                                        ...
                                        <th>ACT</th>
                                        <th>Stage</th>                    
                                        <th>VakilPatraFiledBy</th>
                                        <th>VakilPatraFiledOn</th>
                                        <th>CaseCategory</th>                    
                                        <th>OpponentName</th>
                                        <th>OpponentAdvocate</th>                    
                                        <th>Remarks</th>
                                        <th>OtherInfo</th>
                                        <th>CreateDate</th>                    
                                        <th>CreateUser</th>
                                ...
                                <tbody>
                                    <c:forEach items="${casemasters}" var="casemaster">
                                        <tr>
                                            <td><a href="CaseMasterController?action=edit&CaseMasterID=<c:out value="${casemaster.cad_ID}"/>">Edit</a></td>
                                            <td><a href="#" onclick="deleterecord(<c:out value="${casemaster.cad_ID},'${casemaster.cad_CaseNo}','${casemaster.cad_FileName}'"/>);">Delete</a></td>
                                         <!--<td><a href="CaseMasterController?action=delete&CaseMasterID=<c:out value="${casemaster.cad_ID}"/>">Delete</a></td>-->
                                         <!--   <td><c:out value="${casemaster.cad_ID}" /></td>  -->
                                            <td><c:out value="${casemaster.cad_CaseNo}" /></td>                                                
                                            <td><c:out value="${casemaster.cad_FileName}" /></td>
                                            <td><c:out value="${casemaster.cad_FileNo}" /></td>
                                        <!--<td><c:out value="${casemaster.cad_RegNo}" /></td> -->                                               
                                            <td><c:out value="${casemaster.cad_CaseType}" /></td>
                                            <td><c:out value="${casemaster.cad_AssetCode}" /></td>
                                            <td><c:out value="${casemaster.cad_ClientName}" /></td>
                                            <td><c:out value="${casemaster.cad_Location}" /></td>
                                            <td><c:out value="${casemaster.cad_Court}" /></td>
                                            <td><c:out value="${casemaster.cad_AppearingFor}" /></td>
                                            <td><c:out value="${casemaster.cad_Advocate}" /></td>
                                            <td><c:out value="${casemaster.cad_ACT}" /></td>
                                            <td><c:out value="${casemaster.cad_Stage}" /></td>
                                            <td><c:out value="${casemaster.cad_VakilPatraFiledBy}" /></td>
                                            <td><fmt:formatDate value="${casemaster.cad_VakilPatraFiledOn}" pattern="dd/MM/yyyy" /></td>                                              
                                            <td><c:out value="${casemaster.cad_CaseCategory}" /></td>
                                            <td><c:out value="${casemaster.cad_OpponentName}" /></td>
                                            <td><c:out value="${casemaster.cad_OpponentAdvocate}" /></td>
                                            <td><c:out value="${casemaster.cad_Remarks}" /></td>
                                            <td><c:out value="${casemaster.cad_OtherInfo}" /></td>                                                
                                            <td><fmt:formatDate value="${casemaster.cad_CreateDate}" pattern="dd/MM/yyyy" /></td>                                                
                                            <td><c:out value="${casemaster.cad_CreateUser}" /></td>
                                            <td><fmt:formatDate value="${casemaster.cad_ModifyDate}" pattern="dd/MM/yyyy" /></td>                                                 
                                            <td><c:out value="${casemaster.cad_ModifyUser}" /></td>
                                        <!--    <td><c:out value="${casemaster.cad_ActiveFlag}" /></td>
                                            <td><c:out value="${casemaster.cad_DeleteFlag}" /></td>-->
