<%-- 
    ...
    Created on : Jan 10, 2019, 11:19:18 AM
    Author     : nishad
--%>
...
function deleteRecord(id,Category){
  ...
  if(doIt){
   var f=document.form;
    ...
    window.location.href="CategoryController?action=delete&categoryID="+id;
    f.submit();
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" action="ctsAddCategory.jsp" method="post" class="add" id="commentForm">
                    <p><button type="submit" name="AddCategory" value="AddCategory" class="btn btn-primary">Add New Category</button></p>
                </form>   
                            ...
                            <tfoot>
                                ...
                                <tbody>
                                    <c:forEach items="${categories}" var="category">
                                            <tr>
                                                <td><a href="CategoryController?action=edit&categoryID=<c:out value="${category.ccg_ID}"/>">Update</a></td>
                                                <td><a href="#" onclick="deleteRecord(<c:out value="${category.ccg_ID},'${category.ccg_CategoryName}'" /> );">Delete</a></td>
                                         <!--      <td><a href="CategoryController?action=delete&categoryID=<c:out value="${category.ccg_ID}"/>">Delete</a></td>-->
    


                                         <!--   <td><c:out value="${category.ccg_ID}" /></td>                        -->
                                                <td><c:out value="${category.ccg_CategoryName}" /></td>
                                                <td><c:out value="${category.ccg_Description}" /></td>
                                                
                                            <!--    <td><fmt:formatDate value="${category.ccg_CreateDate}" pattern="dd/MM/yyyy" /></td>                                                                       
                                                <td><c:out value="${category.ccg_CreateUser}" /></td>
                                                <td><fmt:formatDate value="${category.ccg_ModifyDate}" pattern="dd/MM/yyyy" /></td>                                                      
                                                <td><c:out value="${category.ccg_ModifyUser}" /></td>
                                                <td><c:out value="${category.ccg_ActiveFlag}" /></td>
                                                <td><c:out value="${category.ccg_DeleteFlag}" /></td>-->
