...
public class SCasePaymentsDAO {
     private Connection connection;

    public SCasePaymentsDAO() {
     ...
     public void deleteCasePayment(int CasePaymentID) {
        try {
            PreparedStatement preparedStatement = connection
                    .prepareStatement("UPDATE cts_scasepayments SET ccp_DeleteFlag = 1 Where ccp_ID=?");
     ...
     public CasePayments getCasePaymentByID(int CasePaymentID) {
        ...
        try {
            PreparedStatement preparedStatement = connection.
                    prepareStatement("SELECT ccp_ID,cad_ID,cad_RegNo,cad_CaseNo,cad_FileNo,cad_FileName,cad_ClientName,ccp_PaymentDate,ccp_PaymentType,ccp_PaymentAmount, ccp_PaymentChequeDate,ccp_PaymentChequeNo,ccp_PaymentChequeName,ccp_NEFTTransactionNo,ccp_TDSAmount,ccp_DepositBank,ccp_CreateDate,ccp_CreateUser,ccp_ModifyDate,ccp_ModifyUser,ccp_ActiveFlag,ccp_DeleteFlag,ccp_PaymentChequeBank FROM cts_scasepayments where ccp_ID = ? AND ccp_DeleteFlag = 0");
            preparedStatement.setInt(1, CasePaymentID);
            ResultSet rs = preparedStatement.executeQuery();
     ...
     public CasePayments getCaseDetailByPaymentId(int CasePaymentID) {
        ...
        try {
            PreparedStatement preparedStatement = connection.
                    prepareStatement("SELECT cad_ID,cad_RegNo,cad_CaseNo,cad_FileNo,cad_FileName,cad_ClientName from cts_scasepayments where cad_ID = (Select cad_ID  from cts_scasepayments where ccp_ID = ?)  AND ccp_DeleteFlag = 0");
            preparedStatement.setInt(1, CasePaymentID);
            ResultSet rs = preparedStatement.executeQuery();
     ...
     public CasePayments getCaseDetailByCaseID(int CaseMasterID) {
        ...
        try {
            PreparedStatement preparedStatement = connection.
                    prepareStatement("SELECT cad_ID,cad_RegNo,cad_CaseNo,cad_FileNo,cad_FileName,cad_ClientName from cts_scasepayments where cad_ID = ?  AND ccp_DeleteFlag = 0");
            preparedStatement.setInt(1, CaseMasterID);
            ResultSet rs = preparedStatement.executeQuery();
     ...
     public void addCasePayment(CasePayments casepayment) {                  
      ...
      public void updateCasePayment(CasePayments casepayment) {
        try {
            PreparedStatement preparedStatement = connection
                    .prepareStatement("UPDATE cts_scasepayments SET ccp_PaymentDate = ?, ccp_PaymentType = ?, ccp_PaymentAmount = ?, ccp_PaymentChequeDate = ?, ccp_PaymentChequeNo = ?, ccp_PaymentChequeName = ?, ccp_NEFTTransactionNo = ?, ccp_TDSAmount = ?, ccp_DepositBank = ?, ccp_ModifyDate = ?, ccp_ModifyUser = ?, ccp_PaymentChequeBank = ? WHERE ccp_ID = ?");
            // Parameters start with 1
