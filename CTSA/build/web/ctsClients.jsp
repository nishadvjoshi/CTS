<%-- 
    Document   : ctsClients
    Created on : 4 Oct, 2017, 2:09:49 PM
    Author     : Admin
--%>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" action="ctsAddClient.jsp">
                    <p><button type="submit" name="AddClient" value="AddClient" class="btn btn-primary">New Client</button></p>
                </form>   
                            ...
                            <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach items="${clients}" var="client">
                                            <tr>
                                                <td><a href="ClientController?action=edit&ClientID=<c:out value="${client.cmc_ID}"/>">Edit</a></td>
                                           <!-- <td><a href="ClientController?action=delete&ClientID=<c:out value="${client.cmc_ID}"/>">Delete</a></td>-->
                                             <td><a href="#" onclick="deleteRecord(<c:out value="${client.cmc_ID},'${client.cmc_FirstName}'" /> );" >Delete</a></td>
                                                
                                             <!--<td><c:out value="${client.cmc_ID}" /></td>-->
                                                <td><c:out value="${client.cmc_FirstName}" /></td>                                                
                                            <!-- <td><c:out value="${client.cmc_ClientType}" /></td>
                                                <td><c:out value="${client.cmc_OrgName}" /></td>-->

                                                <td><c:out value="${client.cmc_EmailID1}" /></td>
                                                <!--<td><c:out value="${client.cmc_EmailID2}" /></td>-->
                                                <td><c:out value="${client.cmc_CellNo1}" /></td>
                                                <!--<td><c:out value="${client.cmc_CellNo2}" /></td>
                                                <td><c:out value="${client.cmc_LandlineNo}" /></td>-->
