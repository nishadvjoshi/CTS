            ...
            <div class="container-fluid">
                ...
                <body class="bg-dark">
                    ...
                    <form method="POST" class="register" action='CaseDetailController' name="frmAddCaseDetail">
                        ...
                        <P><label>Case ID : </label>  <input type="text" readonly="hidden" style="width:auto;" class="form-control" placeholder="CaseID" name="cad_ID" value="<c:out value="${casemaster.cad_ID}" />" /> </p>                        
                        <P><label>Case Number : </label> <input type="text" readonly="hidden" style="width:auto;" class="form-control" placeholder="CaseNumber" name="cad_CaseNo" value="<c:out value="${casemaster.cad_CaseNo}" />" />  </p>
                        <P><label>File Name : </label> <input type="text" readonly="hidden" style="width:auto;" class="form-control" placeholder="FileName" name="cad_FileName" value="<c:out value="${casemaster.cad_FileName}" />" />  </p>
                        ...
                        <p> <label >Select Attending Advocate  : </label> 
                            ...
                            <select data-placeholder="Select Advocate..." name ="ccd_AAdvocate" data-toggle="tooltip" title="Select Advocate Attending Case"  class="chosen-select" style="width:auto;height:100px;"  >
                        ...
                        <p> <label>Select Case State  :</label> 
                            ...
                            <select data-placeholder="Select Case State..." name ="ccd_Stage" data-toggle="tooltip" title="Select Correct Case Stage" class="chosen-select" style="width:auto;height:100px;" >
                        ...
                        <p> <label>Select Court  :</label> 
                            ...
                            <select data-placeholder="Select Court..." name ="ccd_Court" class="chosen-select" data-toggle="tooltip" title="Select Court" style="width:auto;height:100px;" >
                        ...
                        <div hidden="">
                        <input type="text" type="hidden" style="width:auto;" class="form-control" placeholder="Registration No" name="cad_RegNo" value="<c:out value="${casemaster.cad_RegNo}" />" />
                        ...
                        <input type="text"  style="width:200px;"  class="form-control" placeholder="CaseDetailID" name="ccd_id" value="<c:out value="${casemdetail.ccd_ID}" />" /> 
                        <input type="text" style="width:200px;"  class="form-control" placeholder="ClientID" name="cmc_ID" value="<c:out value="${casemaster.cmc_ID}" />" /> 
                        ...
                        <input type="text"  class="form-control" name="ccd_EditFlag" value="<%=request.getAttribute("upd")%>" /> 
