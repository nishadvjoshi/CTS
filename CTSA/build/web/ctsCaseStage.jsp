<%-- 
    Document   : ctsCaseStage
    Created on : 8 Sep, 2017, 9:20:22 PM
    Author     : Admin
--%>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" action="ctsAddCaseStage.jsp">
                    <p><button type="submit" name="AddCaseStage" value="AddCaseStage" class="btn btn-primary">New Case Stage</button></p>
                </form>   
                            ...
                            <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach items="${casestages}" var="casestage">
                                        <tr>
                                            <td><a href="CaseStageController?action=edit&casestageID=<c:out value="${casestage.ccs_ID}"/>">Update</a></td>
                                            <td><a href="CaseStageController?action=delete&casestageID=<c:out value="${casestage.ccs_ID}"/>">Delete</a></td>
                                          <!--  <td><c:out value="${casestage.ccs_ID}" /></td>                        -->
                                            <td><c:out value="${casestage.ccs_StageName}" /></td>
                                            <td><c:out value="${casestage.ccs_Description}" /></td>                                                
                                       <td><fmt:formatDate value="${casestage.ccs_CreateDate}" pattern="dd/MM/yyyy" /></td> 
                                         <!--        <td><c:out value="${casestage.ccs_CreateUser}" /></td>                                           -->
                                        </tr>
                                    </c:forEach>
