    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" method="POST" class="sign" id="commentForm" action='CategoryController' name="frmAddCategory">

                    <div class="form-group">

                        <p>
                            <input class="form-control" type="text" readonly="readonly" placeholder="Category ID will be allocated by system..." name="ccg_ID" value="<c:out value="${category.ccg_ID}" />" />
                        </p>
           
                        <p>
                            <input class="form-control" type="text" placeholder="Enter valid Category" id="ccg_CategoryName" name="ccg_CategoryName" data-toggle="tooltip" title="Please Enter Category Name"  value="<c:out value="${category.ccg_CategoryName}" />" required/>
                        </p>
                        <p>
                            <input class="form-control" type="text" placeholder="Tell us about Category" id="ccg_Description" name="ccg_Description" data-toggle="tooltip" title="Please Enter Decription" value="<c:out value="${category.ccg_Description}" />" required/>
                        </p>
                    </div>
                          <input type="hidden" name="ccg_DeleteFlag" value="<c:out value="false" />" /> 
                    <input type="hidden" name="ccg_ActiveFlag" value="<c:out value="true" />" /> 
                    <input type="hidden" name="ccg_CreateDate" value="<fmt:formatDate pattern="MM/dd/yyyy" value="<%= new java.util.Date()%>" />" />                
                    <input type="hidden" name="ccg_CreateUser" value="<c:out value="${sessionScope.cmu_ID}" />" />  
 
                    <input type="hidden" name="ccg_ModifyDate" value="<fmt:formatDate pattern="MM/dd/yyyy" value="<%= new java.util.Date()%>" />" />                
                    <input type="hidden" name="ccg_ModifyUser" value="<c:out value="${sessionScope.cmu_ID}" />" /> 	
