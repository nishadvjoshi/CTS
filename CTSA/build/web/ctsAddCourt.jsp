<%-- 
    Document   : ctsAddCourt
    Created on : 3 Oct, 2017, 1:49:54 PM
    Author     : Admin
--%>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" method="POST" class="register" id="commentForm" action='CourtController' name="frmAddCourt">
                    <div class="form-group">

                        <p>
                            <input class="form-control" type="text" readonly="readonly" placeholder="CourtID will be allocated by system..." name="courtID" value="<c:out value="${court.ccm_ID}" />" />
                        </p>
                        <p>
                            <input class="form-control" type="text" placeholder="Enter court name" id="ccm_CourtName" name="ccm_CourtName" data-toggle="tooltip" title="Please Enter Court Name" value="<c:out value="${court.ccm_CourtName}" />" required/>
                        </p>
                        <p>
                            <input class="form-control" type="text" placeholder="Enter court description" id="ccm_Description" name="ccm_Description" data-toggle="tooltip" title="Please Enter Description" value="<c:out value="${court.ccm_Description}" />" required/>
                        </p>                                    
                        <p>
                            <input class="form-control" type="text" placeholder="Enter court type" id="ccm_CourtType" name="ccm_CourtType" data-toggle="tooltip" title="Please Mention type of court ( District, high, DRT, etc.)" value="<c:out value="${court.ccm_CourtType}" />" />
                        </p>                                    


                    </div>
                    <input type="hidden" name="ccm_DeleteFlag" value="<c:out value="false" />" /> 
                    <input type="hidden" name="ccm_ActiveFlag" value="<c:out value="true" />" /> 
                    <input type="hidden" name="ccm_CreateDate" value="<fmt:formatDate pattern="MM/dd/yyyy" value="<%= new java.util.Date()%>" />" />                
                    <input type="hidden" name="ccm_CreateUser" value="<c:out value="1" />" />                 
                    <input type="hidden" name="ccm_ModifyDate" value="<fmt:formatDate pattern="MM/dd/yyyy" value="<%= new java.util.Date()%>" />" />                
                    <input type="hidden" name="ccm_ModifyUser" value="<c:out value="1" />" /> 	
